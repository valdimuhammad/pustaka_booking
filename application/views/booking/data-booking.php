						...
						<table class="table table-bordered table-striped table-hover" id="table-datatable">
							...
							?>
								<tr>
									...
									<td nowrap>
										<a href="<?= base_url('booking/hapusbooking/' . $t['id_buku']); ?>" onclick="return_konfirm('Yakin tidak Jadi Booking '.$t['judul_buku'])" class="btn btn-sm btn-outline-danger"><i class="fa fa-fw fa-trash"></i></a>
									</td>
								</tr>
							<?php $no++;
							} ?>
